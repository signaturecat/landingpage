...
Wszystkie dokumenty prawne znajdują się pod adresem [signature.cat/legal](https://signature.cat/legal/). Polskie wersje Regulaminu i Polityki prywatności są prawnie wiążące; tłumaczenia angielskie, niemieckie i francuskie są udostępniane dla wygody.
...
> [!NOTE]
> Ta strona to przegląd dla wygody, a nie porada prawna - nie zastępuje wiążących dokumentów pod adresem [signature.cat/legal](https://signature.cat/legal/).
