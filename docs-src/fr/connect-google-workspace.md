...
Après la première connexion, vous arrivez sur **Acceptez les conditions pour commencer**. Cochez "J'ai lu et j'accepte les Conditions d'utilisation et la Politique de confidentialité." (les deux s'ouvrent dans un nouvel onglet) et cliquez sur **Accepter et continuer**.

Cette étape est obligatoire et vient en premier par conception : rien n'est provisionné pour votre organisation tant que les conditions ne sont pas acceptées.

Seul l'administrateur qui a créé l'organisation peut les accepter. Toute autre personne de votre domaine qui se connecte avant cela voit une carte **En attente de votre administrateur** et obtient l'accès dès que l'administrateur fondateur a terminé cette étape.

## Étape 3 : Configurer votre espace de travail

Une fois les conditions acceptées, vous arrivez sur l'écran **Configurez votre espace de travail**. Cliquer sur **Configurer l'espace de travail** crée un compte de service Google Cloud dédié et isolé pour votre organisation - c'est l'identité qui gérera les signatures Gmail en votre nom. Cela prend en général quelques secondes (jusqu'à 15).
...
## Étape 4 : Autoriser la Domain-Wide Delegation
