...
- die Anwendung **app.signature.cat** (der Dienst Signature.Cat - zentrale Verwaltung von Gmail-Signaturen in Google Workspace, nachfolgend: „Dienst“),
- die Informationsseite **signature.cat** samt ihren Sprachunterseiten,
- das Hosting von Signaturbildern (vom Anbieter bereitgestellte Adressen sowie von Kunden konfigurierte Subdomains),
- die mit uns geführte Korrespondenz (E-Mail, Meldungen, Reklamationen).
...
- Daten der Nutzer, die sich beim Dienst anmelden (Personen, die im Namen des Kunden handeln),
- Abrechnungs- und Kontaktdaten des Kunden,
- Daten der Besucher der Seite signature.cat,
- Daten der Personen, die mit uns Kontakt aufnehmen.
...
|---|---|
| Abschluss und Erfüllung des Vertrags: Führung des Kontos, Erbringung der Funktionen des Dienstes, Testzeitraum, Transaktionsbenachrichtigungen | Art. 6 Abs. 1 lit. b |
...
| Erfüllung steuerlicher und buchhalterischer Pflichten | Art. 6 Abs. 1 lit. c |
| Sicherheit des Dienstes und Missbrauchsprävention: Begrenzung des Datenverkehrs, Sanitisierung von Inhalten, Audit-Log, Register der Testzeiträume, interne Benachrichtigungen über Kontoereignisse | Art. 6 Abs. 1 lit. f (berechtigtes Interesse: Schutz des Dienstes und der Kunden) |
| Bearbeitung von Meldungen, Anfragen und Reklamationen | Art. 6 Abs. 1 lit. b oder f |
| Feststellung, Geltendmachung oder Verteidigung von Ansprüchen | Art. 6 Abs. 1 lit. f |
...
| Kategorie | Datenumfang | Ort der Verarbeitung |
|---|---|---|
| Hosting-Anbieter für die Anwendung und die Datenbank | alle Daten des Dienstes | EU (Amsterdam) |
| Anbieter von Netzwerkdiensten, CDN und Bildspeicher | Netzwerkverkehr, Bilder der Kunden | Bildspeicher: EU-Jurisdiktion; Netzwerk: globale Edge-Infrastruktur |
| Cloud-Dienstleister (Secret-Management, Archiv des Audit-Logs) | technische Schlüssel der Dienstkonten, Audit-Archiv | Archiv: EU-Region; Secrets: multiregionale Replikation |
...
| Anbieter transaktionaler E-Mails | E-Mail-Adresse des Empfängers, Vor- und Nachname oder Bezeichnung, Inhalt der Benachrichtigung | EU/USA |
| Google (Google Workspace-Dienste und -APIs) | OAuth-Anmeldung, Operationen im Workspace des Kunden | gemäß der Workspace-Konfiguration des Kunden |
...
| Abrechnungs- und Buchhaltungsdokumente | 5 Jahre, gerechnet ab dem Ende des Steuerjahres (gesetzliche Pflicht) |
| Korrespondenz und Meldungen | für die Dauer der Bearbeitung der Angelegenheit, danach bis zum Ablauf der Verjährungsfristen für Ansprüche |
...
| `NEXT_LOCALE` | Speicherung der gewählten Sprache der Benutzeroberfläche | 12 Monate |
...
| Cookie | Zweck | Dauer |
|---|---|---|
| `sigcat_locale` | Speicherung der manuell gewählten Sprache der Seite | 12 Monate |
| `_ga`, `_ga_*` (Google Analytics 4) | Besucherstatistik | bis zu 24 Monate |
...
- TLS-Verschlüsselung des gesamten Datenverkehrs, mit erzwungenem HTTPS (HSTS);
- Verschlüsselung der OAuth-Tokens im Ruhezustand mit dem Algorithmus AES-256-GCM, wobei der Verschlüsselungsschlüssel außerhalb der Datenbank aufbewahrt wird;
